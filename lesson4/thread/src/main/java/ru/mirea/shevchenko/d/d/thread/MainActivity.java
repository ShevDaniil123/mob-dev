package ru.mirea.shevchenko.d.d.thread;
...
import ru.mirea.shevchenko.d.d.thread.databinding.ActivityMainBinding;
...
// Меняем имя и выводим в текстовом поле
        mainThread.setName("ГРУППА: БИСО-03-20, НОМЕР ПО СПИСКУ: 27, МОЙ ЛЮБИИМЫЙ ФИЛЬМ: Брат");
