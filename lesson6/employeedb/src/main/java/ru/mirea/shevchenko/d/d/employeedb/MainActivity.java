package ru.mirea.shevchenko.d.d.employeedb;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(v -> {
            ...
            if (name.isEmpty()) {
                Toast.makeText(this, "Имя", Toast.LENGTH_LONG).show();
                return;
            }
            ...
            dao.insert(hero);
            Toast.makeText(this, "Новый герой добавлен!", Toast.LENGTH_LONG).show();
            clearFields();
            loadHeroesToList();
        });
        ...
        update.setOnClickListener(v -> {
            if (selectedHeroId == -1) {
                Toast.makeText(this, "Выберите героя", Toast.LENGTH_LONG).show();
                return;
            }
